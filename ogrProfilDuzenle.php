<?php
		include_once("/Controller/ogrenciProfilDuzenleC.php");
  //$nesneProfil=new OgrenciProfilDuzenleC();
...
if (@$_POST["profilduzenle"]) {
  $sonuc=OgrenciProfilDuzenleC::profilDuzenle();// nesne üzerinden değil de sınıf üzerinden func çalıştırdım
  echo $sonuc;
}
$kisi =OgrenciProfilDuzenleC::profilGetir();
?>
<center>
        <div class="col-md-6" >
